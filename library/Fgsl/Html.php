...
//		if($class=='Fgsl_Html_Decorator')
	//		$class = Fgsl_Html_Constants::HTML_DECORATOR_TABLE;


	//const HTML_DECORATOR_TABLE = 'Fgsl_Html_Table';
	//const HTML_DECORATOR_SELECT = 'Fgsl_Html_Select';

		//if(count(get_class_methods($class))==0)
			//$class = "Zend_Html_".$tokens[count($tokens)-1];
